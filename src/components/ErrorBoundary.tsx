      ...
      return (
        <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center p-8">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-sm text-foreground border border-white/10 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary"
          >
            Try again
          </button>
        </div>
