...
export function MusicPanel({
  ...
  return (
    <div
      ref={panelRef}
      className="fixed z-[300] rounded-xl overflow-hidden shadow-[0_25px_80px_rgba(0,0,0,0.55)] border backdrop-blur-md
        left-4 right-4 w-auto max-lg:left-4 max-lg:right-4
        lg:left-[calc(var(--app-nav-width,0px)+1rem)] lg:right-auto lg:w-[300px]"
      style={{
        background: 'rgba(12,15,30,0.94)',
        borderColor: 'rgba(255,255,255,0.12)',
        bottom: 'calc(var(--app-bottom-nav-height, 0px) + env(safe-area-inset-bottom, 0px) + 5.25rem)',
      }}
      role="dialog"
      aria-modal="true"
