...
export function SystemMetricsTile() {
  ...
  return (
    <section
      className="glass-panel col-span-1 row-span-1 flex flex-col overflow-hidden p-6 relative min-h-[200px]"
      aria-labelledby="system-tile-heading"
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-cyan-400/70 via-primary/40 to-transparent" />
